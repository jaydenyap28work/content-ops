...
export type ShootingFormat='q_and_a'|'talking_head'|'product_demo'|'podcast'|'voice_over'|'event'
export interface ShootingPackSegment{id:string;kind:string;prompt:string;referenceScript:string;keywords:string[];visualCue:string;onScreenText:string;isShot:boolean}
