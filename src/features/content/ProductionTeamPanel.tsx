...
export function ProductionTeamPanel({workspaceId,clientId,contentId,contributors,canManage,onChanged}:{workspaceId:string;clientId:string;contentId:string;contributors:ContentContributorRecord[];canManage:boolean;onChanged:()=>Promise<void>}){
