...
const messages = {
  'zh-CN': {
    dashboard:'工作台',brandHub:'LKSoft 品牌中心',brand:'品牌',ideas:'内容计划',content:'制作中心',calendar:'日历',analytics:'数据分析',teamReports:'团队报表',tasks:'待办',equipmentProposals:'装备提案',clients:'客户',team:'团队',references:'灵感库',assets:'素材库',music:'音乐库',playbook:'剪辑规范',settings:'设置',
    ...
    new:'新选题',evaluating:'评估中',approved:'已批准',converted:'已转内容',rejected:'已拒绝',archived:'已归档',awaiting_schedule:'待安排拍摄',scheduled_shoot:'已安排拍摄',ready_to_shoot:'待安排拍摄',shooting:'拍摄中',shot_awaiting_edit:'待剪辑',editing:'剪辑中',first_cut_submitted:'初剪已提交',internal_review:'审核中',revision_required:'需修改',client_review:'客户审核',ready_for_publishing:'待发布',completed:'已完成',
  },
  en: {
    dashboard:'Workspace',brandHub:'LKSoft Brand Hub',brand:'Brand',ideas:'Content Plan',content:'Production Center',calendar:'Calendar',analytics:'Analytics',teamReports:'Team Report',tasks:'Tasks',equipmentProposals:'Equipment Proposals',clients:'Clients',team:'Team',references:'Inspiration Library',assets:'Assets',music:'Music',playbook:'Editing Playbook',settings:'Settings',
...
export const routeTranslationKeys:Record<string,TranslationKey>={'/':'dashboard','/brand/lksoft':'brandHub','/ideas':'ideas','/content':'content','/calendar':'calendar','/analytics':'analytics','/team-reports':'teamReports','/tasks':'tasks','/equipment-proposals':'equipmentProposals','/clients':'clients','/team':'team','/references':'references','/assets':'assets','/music':'music','/editing-playbook':'playbook','/settings':'settings'}
