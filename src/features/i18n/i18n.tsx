...
const messages = {
  'zh-CN': {
    dashboard:'工作台',brandHub:'LKSoft 品牌中心',brand:'品牌',ideas:'内容计划',content:'制作中心',calendar:'日历',analytics:'数据分析',clients:'客户',team:'团队',references:'灵感库',assets:'素材库',music:'音乐库',playbook:'剪辑规范',settings:'设置',
  ...
  en: {
    dashboard:'Workspace',brandHub:'LKSoft Brand Hub',brand:'Brand',ideas:'Content Plan',content:'Production Center',calendar:'Calendar',analytics:'Analytics',clients:'Clients',team:'Team',references:'Inspiration Library',assets:'Assets',music:'Music',playbook:'Editing Playbook',settings:'Settings',
...
export const routeTranslationKeys:Record<string,TranslationKey>={'/':'dashboard','/brand/lksoft':'brandHub','/ideas':'ideas','/content':'content','/calendar':'calendar','/analytics':'analytics','/clients':'clients','/team':'team','/references':'references','/assets':'assets','/music':'music','/editing-playbook':'playbook','/settings':'settings'}
