...
const messages = {
  'zh-CN': {
    dashboard:'工作台',ideas:'内容计划',content:'内容',calendar:'日历',analytics:'数据分析',clients:'客户',team:'团队',references:'灵感库',assets:'素材库',music:'音乐库',playbook:'剪辑规范',settings:'设置',
  ...
  en: {
    dashboard:'Workspace',ideas:'Content Plan',content:'Content',calendar:'Calendar',analytics:'Analytics',clients:'Clients',team:'Team',references:'Inspiration Library',assets:'Assets',music:'Music',playbook:'Editing Playbook',settings:'Settings',
