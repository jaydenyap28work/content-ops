...
const messages = {
  'zh-CN': {
    dashboard:'工作台',brandHub:'LKSoft 品牌中心',brand:'品牌',ideas:'内容计划',content:'制作中心',calendar:'日历',analytics:'数据分析',tasks:'待办',equipmentProposals:'装备提案',clients:'客户',team:'团队',references:'灵感库',assets:'素材库',music:'音乐库',playbook:'剪辑规范',settings:'设置',
