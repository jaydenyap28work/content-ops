...
export interface SocialAccountRecord { id:string; client_id:string; platform_id:string; account_name:string; account_handle:string|null; external_url:string|null; is_active:boolean }
