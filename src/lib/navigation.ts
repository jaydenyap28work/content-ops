import{Activity,Archive,BookOpen,Building2,CalendarDays,FileText,FolderOpen,LayoutDashboard,Lightbulb,Music2,Settings,Users}from'lucide-react'
...
export const navigationSections:NavigationSection[]=['Daily Work','Results','Management','Resources','Settings']
