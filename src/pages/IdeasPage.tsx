...
import { Archive, ArrowRight, CheckCircle2, Lightbulb, LoaderCircle, Pencil, Plus, RotateCcw, Search, XCircle } from 'lucide-react'
...
import {
  changeIdeaStatus, loadIdeas, loadReferences, loadResearchCatalog,
...
export function IdeasPage() {
  ...
  function openEditor(idea: IdeaRecord | null) {
    setEditing(idea)
    setError(null)
  }
  ...
  return <div className="page-enter space-y-6" aria-busy={busy}>
