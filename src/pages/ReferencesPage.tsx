...
export function ReferencesPage() {
  ...
  return <div className="page-enter space-y-6">
    <header className="flex flex-col gap-5 border-b border-line pb-6 sm:flex-row sm:items-end sm:justify-between"><div><p className="text-xs font-extrabold uppercase tracking-[0.22em] text-coral">Research / Reference Library</p><h2 className="mt-2 font-display text-4xl font-semibold tracking-[-0.03em] sm:text-5xl">Study what deserves to travel.</h2><p className="mt-3 max-w-2xl leading-7 text-ink-soft">Capture accounts and content worth learning from, then turn the right lesson into a Client-specific Idea.</p></div><Button onClick={() => openEditor(null)}><Plus className="size-4" />New Reference</Button></header>
